...
describe('platform-compatibility', () => {
  ...
  it('instagram rejects text-only', () => expect(isCompatible('instagram', 'text-only')).toBe(false));
  ...
  it('pinterest rejects text-only', () => expect(isCompatible('pinterest', 'text-only')).toBe(false));
  ...
  it('unknown platform is incompatible', () => expect(isCompatible('unknown', 'image')).toBe(false));
  it('getContentMediaType returns text-only for null', () => expect(getContentMediaType(null)).toBe('text-only'));
  it('getContentMediaType returns image for url', () => expect(getContentMediaType('/assets/123.png')).toBe('image'));
});
