    ...
    <div style={{ width: '100%', height: 250, marginTop: '12px' }}>
      <ResponsiveContainer>
        <LineChart data={data}>
          ...
          <Line type="monotone" dataKey="views" stroke="#3b82f6" strokeWidth={2} dot={false} name="Views" connectNulls />
          <Line type="monotone" dataKey="likes" stroke="#22c55e" strokeWidth={2} dot={false} name="Likes" connectNulls />
        </LineChart>
      </ResponsiveContainer>
    </div>
  );
